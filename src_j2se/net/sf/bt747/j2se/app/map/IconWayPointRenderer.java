 ...
 * 
 */
public class IconWayPointRenderer implements BT747WaypointRenderer {

    private final static float scale = 8f;
    private final static GeneralPath gp = new GeneralPath();
    private final static IconWayPointRenderer instance = new IconWayPointRenderer();
    ...
    public boolean isRendererOf(final Object o) {
        return (o instanceof GPSPositionWaypoint);
    }
