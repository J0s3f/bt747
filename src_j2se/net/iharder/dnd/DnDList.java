 ...
 * objects in the list will be passed either as a String by calling the
 * object's <tt>toString()</tt> object, or if your drag and drop target
 * accepts the {@link TransferableObject#DATA_FLAVOR} data flavor then the
 * actual object will be passed.
 * 
 * <p>
...
public class DnDList extends javax.swing.JList implements
     ...
     * @since 1.1
     */
    public DnDList(final javax.swing.DefaultListModel model) {
        super(model);
        initComponents();
    } // end constructor
     ...
     * @since 1.1
     */
    public DnDList(final Object[] data) {
        this();
     ...
     * @since 1.1
     */
    public DnDList(final java.util.Vector data) {
        this();
    ...
    public void dragGestureRecognized(
            final java.awt.dnd.DragGestureEvent event) { // System.out.println(
        // "DragGestureListener.dragGestureRecognized"
        // );
        final Object selected = getSelectedValue();
        if (selected != null) {
            sourceIndex = getSelectedIndex();
            final java.awt.datatransfer.Transferable transfer = new TransferableObject(
    ...
    public void dragDropEnd(final java.awt.dnd.DragSourceDropEvent evt) { // System.out.println(
        // "DragSourceListener.dragDropEnd"
        // );
    } // end dragDropEnd

    public void dragEnter(final java.awt.dnd.DragSourceDragEvent evt) { // System.out.println(
        // "DragSourceListener.dragEnter"
        // );
    } // end dragEnter

    public void dragExit(final java.awt.dnd.DragSourceEvent evt) { // System.out.println(
        // "DragSourceListener.dragExit"
        // );
    } // end dragExit

    public void dragOver(final java.awt.dnd.DragSourceDragEvent evt) { // System.out.println(
        // "DragSourceListener.dragOver"
        // );
    } // end dragOver

    public void dropActionChanged(final java.awt.dnd.DragSourceDragEvent evt) { // System.out.println(
    ...
    public void dragEnter(final java.awt.dnd.DropTargetDragEvent evt) { // System.out.println(
        // "DropTargetListener.dragEnter"
        // );
        evt.acceptDrag(java.awt.dnd.DnDConstants.ACTION_MOVE);
    } // end dragEnter

    public void dragExit(final java.awt.dnd.DropTargetEvent evt) { // System.out.println(
        // "DropTargetListener.dragExit"
        // );
    } // end dragExit

    public void dragOver(final java.awt.dnd.DropTargetDragEvent evt) { // System.out.println(
        // "DropTargetListener.dragOver"
        // );
    } // end dragOver

    public void dropActionChanged(final java.awt.dnd.DropTargetDragEvent evt) { // System.out.println(
        // "DropTargetListener.dropActionChanged"
        // );
        evt.acceptDrag(java.awt.dnd.DnDConstants.ACTION_MOVE);
    } // end dropActionChanged

    public void drop(final java.awt.dnd.DropTargetDropEvent evt) { // System.out.println(
        // "DropTargetListener.drop"
        // );
        final java.awt.datatransfer.Transferable transferable = evt
                .getTransferable();

        // If it's our native TransferableObject, use that
        if (transferable
                .isDataFlavorSupported(TransferableObject.DATA_FLAVOR)) {
            ...
            if (obj != null) {
                ...
                final javax.swing.DefaultListModel model = (javax.swing.DefaultListModel) getModel();
