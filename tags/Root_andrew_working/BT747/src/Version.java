...
public final class Version {
   ...
   public static final long BUILD = 20071112232835566L; //automatically set during Ant compilation!
   /** Release date of this version (date format dd.MM.yyyy). */
   public static final String DATE = "12.11.2007"; //automatically set during Ant compilation!
   /**
    ...
    * </ul>
    */
   public static final String VERSION_NUMBER = "1.11";
