...
public class Txt_de {
   ...
   public final static String ABOUT_TXT=
       ...
       "|m.deweerd@ieee.org"+
       "|"+
       "|Diese Anwendung erlaubt die Kontrolle über" +
       "|den iBlue 747 Empfänger." +
   ...
   public final static String DISCLAIMER_TXT=
       "Die Software wird zur Verfügung gestellt," +
   ...
   public final static String BT_CLOSE_PRT = "Schnittstelle schließen";
   public final static String BT_REOPEN_PRT  = "Schnittstelle öffnen";
   ...
   public static final String BT_FORCED_ERASE = "Erzwungenes Löschen";
   public static final String BT_PT_WITH_REASON = "Klicken für entsprechendes Log-Erzeugnis:";
   ...
   public static final String SET_ERASE = "Setzen und Löschen";
   public static final String SET_NOERASE = "Setzen (nicht Löschen)";
