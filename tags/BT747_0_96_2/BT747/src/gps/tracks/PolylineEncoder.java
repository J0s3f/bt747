...
//	}
	 ...
	 * 
	 */
	public Hashtable dpEncode(Track track) {
		int i, maxLoc = 0;
	...
	public static final String replace(final String s, final String one, final String another) {
...
//	}
	 ...
	 */
	private String encodeLevels(Track points, double[] dists,
			double absMaxDist) {
		int i;
...
//		System.out.println("encodedLevels: " + encoded_levels);
	...
	private String createEncodings(Track points, double[] dists) {
