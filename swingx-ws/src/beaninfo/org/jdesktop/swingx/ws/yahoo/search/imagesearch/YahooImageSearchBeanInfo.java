/*
 * $Id: YahooImageSearchBeanInfo.java,v 1.1 2006/07/17 20:52:15 rbair Exp $
 *
    ...
    public static EnumerationValue[] getFileFormatEnumValues() {
        ...
        for (int i=0; i<values.length; i++) {
            results[i+1] = new EnumerationValue(values[i].
                    name(), values[i], "org.jdesktop.swingx.ws.yahoo.search.imagesearch.FileFormat" + values[i].name());
        }
        return results;
    }
}