 ...
 * @author joshy
 */
public class JXMapKitNewMapViewer extends JXPanel {
    ...
    public enum DefaultProviders {
        ...
        SwingLabsBlueMarble, OpenStreetMap, Custom
    };
...
//        miniMap.setCenterPosition(new GeoPosition(0,0));
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        mainMap = new org.jdesktop.swingx.JXNewMapViewer();
        miniMap = new org.jdesktop.swingx.JXNewMapViewer();
        ...
        miniMapMinimizeButton.setOpaque(false);
        ...
        miniMapMaximizeButton.setOpaque(false);
        ...
        sliderPanel.add(zoomOutButton, gridBagConstraints);
        ...
        sliderPanel.add(zoomSlider, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        sliderPanel.add(zoomInButton, gridBagConstraints);
