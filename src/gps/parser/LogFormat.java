...
/**
 * A LogFormat object is a container for the layout-information of the following
 * LogPackets. <br>
...
public class LogFormat {
    ...
    public boolean hasFix() {
        return ((this.format & (1 << 1)) != 0);
    }

    public boolean hasLatitude() {
        return ((this.format & (1 << 2)) != 0);
    }

    public boolean hasLongitude() {
        return ((this.format & (1 << 3)) != 0);
    }

    public boolean hasHeight() {
        return ((this.format & (1 << 4)) != 0);
    }

    public boolean hasSpeed() {
        return ((this.format & (1 << 5)) != 0);
    }

    public boolean hasHeading() {
        return ((this.format & (1 << 6)) != 0);
    }

    public boolean hasDSta() {
        return ((this.format & (1 << 7)) != 0);
    }

    public boolean hasDAge() {
        return ((this.format & (1 << 8)) != 0);
    }

    public boolean hasPDOP() {
        return ((this.format & (1 << 9)) != 0);
    }

    public boolean hasHDOP() {
        return ((this.format & (1 << 10)) != 0);
    }

    public boolean hasVDOP() {
        return ((this.format & (1 << 11)) != 0);
    }

    public boolean hasNSat() {
        return ((this.format & (1 << 12)) != 0);
    }

    public boolean hasSID() {
        return ((this.format & (1 << 13)) != 0);
    }

    public boolean hasElevation() {
        return ((this.format & (1 << 14)) != 0);
    }

    public boolean hasAzimuth() {
        return ((this.format & (1 << 15)) != 0);
    }

    public boolean hasSNR() {
        return ((this.format & (1 << 16)) != 0);
    }

    public boolean hasRCR() {
        return ((this.format & (1 << 17)) != 0);
    }

    public boolean hasMSec() {
        return ((this.format & (1 << 18)) != 0);
    }

    public boolean hasDist() {
        return ((this.format & (1 << 19)) != 0);
    }

    public boolean isLowPrecision() {
        return ((this.format & (1 << 31)) != 0);
    }
    ...
    public int getMinPacketSize(LogDataParser parser) {
        ...
        // TODOD A complete calculation has to include the no. of satellite-data
        // records, but excluding them should be accurate enough
