 ...
 */
public final class AndroidDate implements BT747Date {
     ...
     * @param sentDate
     */
    public AndroidDate(final int sentDate) {
     ...
     * @param sentYear
     */
    public AndroidDate(final int sentDay, final int sentMonth, final int sentYear) {
     ...
     * @param strDate
     */
    public AndroidDate(final String strDate) {
     ...
     * @param dateFormat
     */
    public AndroidDate(final String strDate, final byte dateFormat) {
        DateFormat df;
    ...
    public void advance(final int s) {
        cal.add(java.util.Calendar.DAY_OF_MONTH, s);
    }

    public AndroidDate(final java.util.Date d) {
        cal.setTime(d);
    }

    public AndroidDate(final AndroidDate d) {
