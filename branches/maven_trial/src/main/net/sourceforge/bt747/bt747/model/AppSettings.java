...
import net.sourceforge.bt747.bt747.io.File;
import net.sourceforge.bt747.bt747.sys.Convert;
import net.sourceforge.bt747.bt747.sys.Settings;
...
public class AppSettings {
    ...
    (net.sourceforge.bt747.bt747.sys.Settings.platform.startsWith("Win32")
            || net.sourceforge.bt747.bt747.sys.Settings.platform.startsWith("Windows") || net.sourceforge.bt747.bt747.sys.Settings.platform
            .startsWith("Mac")
    ...
    private boolean isWin32LikeDevice() {
        return net.sourceforge.bt747.bt747.sys.Settings.platform.startsWith("WindowsCE")
                || net.sourceforge.bt747.bt747.sys.Settings.platform.startsWith("PocketPC")
                || (net.sourceforge.bt747.bt747.sys.Settings.platform.startsWith("Win32") && Settings.onDevice)
                || !Settings.isWaba();
    }
    ...
    private void updateSettings(final int versionX100) {
        ...
        case 0:
            ...
            setBaudRate(115200);
            setCard(-1);
            if (net.sourceforge.bt747.bt747.sys.Settings.platform.startsWith("Palm")) {
                setBaseDirPath("/Palm");
            } else if (isWin32LikeDevice()) {
                if (net.sourceforge.bt747.bt747.io.File.getCardVolumePath() == null) {
            ...
            setChunkSize(net.sourceforge.bt747.bt747.sys.Settings.onDevice ? 220 : 0x10000);
        ...
        case 12:
            setTraversableFocus(Settings.onDevice
                    && (!net.sourceforge.bt747.bt747.sys.Settings.platform.startsWith("Palm")));
            /* fall through */
        case 13:
