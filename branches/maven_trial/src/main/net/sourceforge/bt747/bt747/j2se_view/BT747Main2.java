 ...
 */
package net.sourceforge.bt747.bt747.j2se_view;

import net.sourceforge.bt747.gps.BT747Constants;
import net.sourceforge.bt747.gps.convert.Conv;
import net.sourceforge.bt747.gps.convert.FileUtil;
...
public class BT747Main2 extends javax.swing.JFrame implements
    net.sourceforge.bt747.bt747.model.ModelListener {
    ...
    private void updateRMCData(final GPSRecord gps) {
        if (gps.utc > 0) {
            ...
            net.sourceforge.bt747.bt747.sys.Time t = new net.sourceforge.bt747.bt747.sys.Time();
    ...
    }// cEN-LAST:event_txtHDOPMaxFocusLost
