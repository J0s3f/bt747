...
/**
 * A LogDataParser knows the technical representation of individual data items
 * on the stream. <br>
...
public class LogDataParser {
     ...
     * <br>
     * Attention: The resulting object isn't operational until the
     * DataInputStream gets set!
     */
     ...
     * 
     * @param aDIS
     *            The stream the parser gets the raw bytes from.
     */
    ...
    public int getRecordingMethodSize() {
        return 2;
    }
