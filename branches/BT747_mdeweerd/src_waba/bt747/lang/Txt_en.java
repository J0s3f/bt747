...
public final class Txt_en implements TxtInterface {
    ...
    private static final String ABOUT_TITLE = "About BT747 V"
    ...
    private static final String ABOUT_SUPERWABA_TITLE = "About SuperWaba";
    ...
    private static final String DISCLAIMER_TXT = "Software is provided 'AS IS,' without"
    ...
    // BT747_dev class
    private static final String[] C_STR_RCR = { "Time", "Speed", "Distance",
            "Button", "Picture", "Gas Stat", "Phone", "ATM", "Bus stop",
            "Parking", "Post Box", "Railway", "Rstaurnt", "Bridge", "View",
            "Other" };
    private static final String[] logFmtItems = { "UTC", // = 0x00001 // 0
            "VALID", // = 0x00002 // 1
            "LATITUDE", // = 0x00004 // 2
            "LONGITUDE",// = 0x00008 // 3
            "HEIGHT", // = 0x00010 // 4
    ...
    private static final String CONFIRM_FACT_RESET = "You are about to perform a factory|"
            + "reset of your GPS Logger Device.|"
            + "||Do you confirm this reset at|" + "your own risk ???";
    ...
    // Log filter
    private static String[] STR_VALID = { "No fix", "SPS", "DGPS", "PPS",
            "RTK", "FRTK", "Estimate", "Manual", "Sim" };
    ...
    private static final String C_msgWarningFormatIncompatibilityRisk = "You will change the format of your device without "
            + "erasing the log.|"
    ...
    private static final String C_msgWarningFormatAndErase = "You are about to change the"
    ...
    private static final String C_msgWarningFormatAndErase2 = "This is your last chance to avoid"
            + "|erasing your device." + "|" + "|LOG FORMAT CHANGE & ERASE?";
    /** Message warning user about impact of changing log format */
    private static final String C_msgEraseWarning = "You are about to"
            + "|erase your device." + "|" + "|LOG ERASE?";
    private static final String C_msgEraseWarning2 = "This is your last chance to avoid"
            + "|erasing your device." + "|" + "|LOG ERASE?";
    ...
    private static final String TITLE_WAITING_ERASE = "Waiting until erase done";
    private static final String TXT_WAITING_ERASE = "Wait until the erase is done.|"
            + "You can cancel waiting (at your risk)";

    private static final String UNKNOWN = "Unknown";
    private static final String CHK_PATH = "|Check path & if Card is writeable";

    private static final String OVERWRITE = "Overwrite";
    private static final String ABORT_DOWNLOAD = "Abort download";
    private static final String DATA_NOT_SAME = "The DATA in the device does NOT|"
    ...
    // GPSFile
    private static final String CLOSE_FAILED = "Closing failed (closeFile) - probably a bug.";
    private static final String WRITING_CLOSED = "Writing to closed file";
    ...
    private static final String TXT_FLASH_LIMITED_WRITES = "The number of writes to the flash|"
            + "is limited and a change in settings|"
            + "could render your device inoperable|"
            + "(e.g., a baud rate change)|" + "ABORT by clicking abort!!";
    private static final String PERIOD_ABBREV = "Per";

    // Forgotten in Advanced track filter
    private static final String IGNORE_0VALUES = "Values of 0 are ignored";

    private static final String STORE_SETTINGS = "Store settings";
    private static final String RESTORE_SETTINGS = "Restore settings";
    private static final String WARNING = "Warning";
    private static final String NO_FILES_WERE_CREATED = "No output files were created!"
            + "||"
            ...
            + "| it may be a bug.";
    private static final String ADD_RECORD_NUMBER = "Record nbr info in logs";

    private static final String BAD_SUPERWABAVERSION = "This application was built for|SuperWaba V";
    private static final String BAD_SUPERWABAVERSION_CONT = ".|This version is V";
    private static final String BAD_SUPERWABAVERSION_CONT2 = ".|Exiting application";
