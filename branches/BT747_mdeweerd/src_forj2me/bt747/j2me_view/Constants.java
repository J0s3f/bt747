...
public interface Constants
{
    ...
    public static final long MIN_XMIT_RATE              = 30L;     // seconds
    
    /** Absolute minimum transmit delay in seconds. */
    public static final long MIN_XMIT_DELAY             = 30L;      // seconds
    
    /** Minimum in-motion interval in seconds. */
    public static final long MIN_IN_MOTION_INTERVAL     = 0L;       // seconds
    
    /** Minimum dormant interval in seconds. */
    public static final long MIN_DORMANT_INTERVAL       = 0L;       // seconds
