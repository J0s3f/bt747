...
public class OutputSettingsPanel extends javax.swing.JPanel implements
    ...
    public OutputSettingsPanel() {
        ...
        cbHeightOverMeanSeaLevel.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { getString("Keep_Height"),
                        getString("WGS84_to_MSL"), getString("Automatic"),
    ...
    private synchronized void setLocale(String locale) {
        if (!settingLocale) {
            settingLocale = true;

            try {
                Locale l = J2SEAppController.localeFromString(locale);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lbLanguage.setText(bundle.getString("OutputSettingsPanel.lbLanguage.text")); // NOI18N
        lbLanguage.setToolTipText(bundle.getString("OutputSettingsPanel.lbLanguage.toolTipText")); // NOI18N
        ...
        pnLanguageLayout.setHorizontalGroup(
            ...
            .add(pnLanguageLayout.createSequentialGroup()
                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .add(pnLanguageLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(pnLanguageLayout.createSequentialGroup()
                        .add(lbLanguage)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(cbLanguage, 0, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void cbLanguageChooserItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbLanguageChooserItemStateChanged
    ...
    private void cbLanguageChooserFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cbLanguageChooserFocusLost
    ...
    private void cbFileUTCTimeupdateLogRecordEstCount(
            java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbFileUTCTimeupdateLogRecordEstCount
        setFileOutputFields();
    }//GEN-LAST:event_cbFileUTCTimeupdateLogRecordEstCount

    private void cbFileMilliSecondsupdateLogRecordEstCount(
            java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbFileMilliSecondsupdateLogRecordEstCount
        setFileOutputFields();
    ...
    private void cbFileHeadingupdateLogRecordEstCount(
            java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbFileHeadingupdateLogRecordEstCount
        setFileOutputFields();
    }//GEN-LAST:event_cbFileHeadingupdateLogRecordEstCount

    private void cbFileDistanceupdateLogRecordEstCount(
            java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbFileDistanceupdateLogRecordEstCount
        setFileOutputFields();
    ...
    private void cbFileAzimuthupdateLogRecordEstCount(
            java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbAzimuth1updateLogRecordEstCount
        setFileOutputFields();
    ...
    private void cbAddTrackPointCommentItemStateChanged(
            java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbAddTrackPointCommentItemStateChanged
    ...
    private void cbAddTrackPointNameItemStateChanged(
            java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbAddTrackPointNameItemStateChanged
