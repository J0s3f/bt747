...
public class ImageListPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {// GEN-BEGIN:initComponents
        ...
        imageIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource(
                "/net/sf/bt747/j2se/app/resources/image.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(imageIcon).add(
                imageText));
        layout.setVerticalGroup(layout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(
                layout.createSequentialGroup().add(imageIcon)
                        .addPreferredGap(
