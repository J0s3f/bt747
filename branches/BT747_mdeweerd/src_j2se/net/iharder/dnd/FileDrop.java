 ...
 * only <tt>javax.swing.JComponent</tt>s will indicate the drop event with a
 * changed border. <p/> To use this class, construct a new <tt>FileDrop</tt>
 * by passing it the target component and a <tt>Listener</tt> to receive
 * notification when file(s) have been dropped. Here is an example: <p/>
 * <code><pre>
 ...
 * dragged by calling the constructor with a <tt>javax.swing.border.Border</tt>.
 * Only <tt>JComponent</tt>s will show any indication with a border. <p/> You
 * can turn on some debugging features by passing a <tt>PrintStream</tt>
...
public class FileDrop {
   ...
   * targets. If your component is a <tt>java.awt.Container</tt>, then each
   ...
   * <tt>System.err</tt>. A <tt>null</tt> value for the parameter
  ...
  public FileDrop(final java.io.PrintStream out, final java.awt.Component c,
    ...
    if (supportsDnD()) { // Make a drop listener
      dropListener = new java.awt.dnd.DropTargetListener() {
        ...
        public void dragOver(java.awt.dnd.DropTargetDragEvent evt) { // This is
          // called
          // continually
          // as long
          // as the
