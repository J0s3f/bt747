...
public class FileDropBean implements java.io.Serializable {
  ...
  /**
   * Registers a component as a drop target. If the component is a container,
   * then all elements contained within will also be registered as drop targets,
   * though only the outer container will change borders during a drag and drop
