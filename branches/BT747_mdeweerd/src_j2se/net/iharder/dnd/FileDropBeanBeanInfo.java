...
public class FileDropBeanBeanInfo extends SimpleBeanInfo {
     ...
     *         will belong to the IndexedPropertyDescriptor subclass of
     ...
     *         fired by this bean. May return null if the information should
     ...
     * bean in toolboxes, toolbars, etc. Icon images will typically be GIFs,
     * but may in future include other formats.
     * <p>
     * Beans aren't required to provide icons and may return null from this
     * method.
     * <p>
     * There are four possible flavors of icons (16x16 color, 32x32 color,
     * 16x16 mono, 32x32 mono). If a bean choses to only support a single icon
     * we recommend supporting 16x16 color.
     * <p>
     * We recommend that icons have a "transparent" background so they can be
     * rendered onto an existing background.
     * 
     * @param iconKind
     *                The kind of icon requested. This should be one of the
