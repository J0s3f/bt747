...
/**
 * Defines the logging level constants. The logging levels are as follows
 * listed in ascending order of importance:
 * <ul>
 * <li><code>DEBUG</code> - Finely grained logging used to track down
 * problems.
 * <li><code>INFO</code> - Documents important and expected program
 * execution.
 * <li><code>WARN</code> - Used for unexpected problems that arise that do
 * not disrupt the program.
 * <li><code>ERROR</code> - Records problems that cause the program to
 * behave improperly.
 * </ul>
 * <p>
...
public class Level {
    ...
    /**
     * The <code>ERROR</code> level designates exceptional behavior that
     * causes something in the application to run improperly.
     */
    ...
    /**
     * Integer representation of the level. The lower the number the lower the
     * priority.
     */
     ...
     */
    private Level(final String levelString, final int levelInt) {
    ...
    /**
     * @return An integer representation of the log level. It can passed into
     *         the <code>setLogLevel</code> method.
     */
    public int toInt() {
        return levelInt;
    }
