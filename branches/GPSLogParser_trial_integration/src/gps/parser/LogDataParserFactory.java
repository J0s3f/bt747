...
/**
 * Dynamically instantiate and return the correct parser for the given LogFormat.
 * @author Thomas Mohme
 */
public class LogDataParserFactory {
	...
	public static LogDataParser getParserForFormat(LogFormat format, DataInputStream dis) {
