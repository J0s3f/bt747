...
/**
 * LogBlock objects represent a structural block in the logfile.
 * <br>
 * A LogBlock knows it's internal structure on the next lower layer and provides methods to 
...
//		System.out.println("creating LogBlock"); //$NON-NLS-1$
		...
		if (aParser != null) {
			...
			parser = LogDataParserFactory.getParserForFormat(hdr.getFormat(), dis);
		}
