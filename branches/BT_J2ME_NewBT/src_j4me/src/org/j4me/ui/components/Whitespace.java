...
public class Whitespace extends Component {
     ...
     * 
     * @param vertical
     *                is the number of pixels to space. It must be 0 or
     *                greater.
     */
    public Whitespace(final int vertical) {
        setSpacing(vertical);
    }

    /**
     * Sets the vertical amount of whitespace this component occupies. This
     * does not include the form's spacing above and below this component.
     * 
     * @param vertical
     *                is the number of pixels to space. It must be 0 or
     *                greater.
