...
public class LogMessage {
    ...
    /**
     * The <code>System.cucurrentTimeMillis</code> at the time the message
     * was logged.
     */
    public long time;
     ...
     */
    protected LogMessage(final Level level, final String message) {
     ...
     *                is the text of the log message.
     */
    protected void setLogMessage(final Level level, final String message) {
        this.level = level;
