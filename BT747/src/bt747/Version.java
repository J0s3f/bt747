...
public final class Version {
   ...
   public static final long BUILD = 20080328012324483L; //automatically set during Ant compilation!
   public static final String BUILD_STR = "BT747.364M.20080328012324483"; //automatically set during Ant compilation!
   /** Release date of this version (date format dd.MM.yyyy). */
   public static final String DATE = "28.03.2008"; //automatically set during Ant compilation!
   /**
