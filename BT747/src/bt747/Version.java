...
public final class Version {
   ...
   public static final long BUILD = 20080223190217202L; //automatically set during Ant compilation!
   public static final String BUILD_STR = "20080223190217202"; //automatically set during Ant compilation!
   /** Release date of this version (date format dd.MM.yyyy). */
   public static final String DATE = "23.02.2008"; //automatically set during Ant compilation!
   /**
    ...
    * </ul>
    */
   public static final String VERSION_NUMBER = "1.40_beta";
