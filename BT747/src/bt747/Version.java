...
public final class Version {
   ...
   public static final long BUILD = 20080327234455827L; //automatically set during Ant compilation!
   public static final String BUILD_STR = "BT747.362M.20080327234455827"; //automatically set during Ant compilation!
   /** Release date of this version (date format dd.MM.yyyy). */
   public static final String DATE = "27.03.2008"; //automatically set during Ant compilation!
   /**
