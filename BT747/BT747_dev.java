...
public final class BT747_dev {  // dev as in device
	...
	public static final int PMTK_LOG_QUERY 	= 2;
	public static final int PMTK_LOG_RESP  	= 3;  // REPLY
	public static final int PMTK_LOG_ON		= 4;
	public static final int PMTK_LOG_OFF		= 5;
	public static final int PMTK_LOG_ERASE 	= 6;
	public static final int PMTK_LOG_REQ_DATA 	= 7;
	public static final int PMTK_LOG_RESP_DATA	= 8;  // REPLY.
	...
	public static final int PMTK_LOG_TBD_3				= 9;
	...
	public static final int PMTK_API_SET_SBAS_ENABLED	= 313;
	...
	public static final int PMTK_API_Q_SBAS_ENABLED	= 413;
	...
	public static final int PMTK_API_GET_USER_OPTION	= 490;
	public static final int PMTK_DT_FIX_CTL	= 500;
	public static final int PMTK_DT_DGPS_MODE	= 501;
	public static final int PMTK_DT_SBAS_ENABLED	= 513;
