 ...
 * <ul>
 * <li>You may include this software with other software that uses a
 * different (even non-open source) license.</li>
...
public class TransferableObject implements java.awt.datatransfer.Transferable {
    ...
    public TransferableObject(final Object data) {
        this.data = data;
        customFlavor = new java.awt.datatransfer.DataFlavor(data.getClass(),
                MIME_TYPE);
    } // end constructor
     ...
     * {@link #DATA_FLAVOR} associated with this class, this creates a custom
     * data flavor with a representation class <var>dataClass</var> and the
    ...
    public TransferableObject(final Class dataClass, final Fetcher fetcher) {
        this.fetcher = fetcher;
        customFlavor = new java.awt.datatransfer.DataFlavor(dataClass,
                MIME_TYPE);
    } // end constructor
