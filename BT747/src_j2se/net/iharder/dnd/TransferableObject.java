...
public class TransferableObject implements java.awt.datatransfer.Transferable {
   ...
   * is returned by <var>fetcher</var>. No custom data flavor is set other than
   * the default {@link #DATA_FLAVOR}.
   * 
   * @see Fetcher
   * @param fetcher
   ...
   * the encapsulated object or <tt>null</tt> if the {@link Fetcher}
  ...
  public java.awt.datatransfer.DataFlavor[] getTransferDataFlavors() {
    if (customFlavor != null)
      return new java.awt.datatransfer.DataFlavor[] { customFlavor,
          DATA_FLAVOR, java.awt.datatransfer.DataFlavor.stringFlavor }; // end
    // flavors
    // array
    else
   ...
   * case you need to remove it from its source (or do anyting else to it). When
   * the {@link #getTransferData getTransferData(...)} method is called on the
