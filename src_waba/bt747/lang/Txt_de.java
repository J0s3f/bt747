...
public final class Txt_de implements TxtInterface {
    ...
    private static final String HGHT_GEOID_DIFF = "H�he-geoid diff";  // diff = difference
    ...
    private static final String TXT_WAITING_ERASE =
        "Warten bis L�schen beendet.|"
        + "Sie k�nnen das Warten auf eigenes|"
        + "Risiko abbrechen";
    ...
    + "den zuvor geladenen DATEN �berein.|"
    + "|"
    ...
    private static final String NO_FILES_WERE_CREATED =
        ...
        + "|- der Filter hat nicht alle Punkte gew�hlt"
        + "|- das Log enth�lt keine Daten"
        + "|"
        + "|Versuchen Sie alle Punkte zu w�hlen."
        + "|Wenn dies nicht funktioniert,"
        + "| ist es m�glicherweise ein Fehler/Bug.";
    ...
    private static final String BAD_SUPERWABAVERSION =
        "Diese Anwendung wurde erstellt|f�r SuperWaba V";
