...
/**
 * LogSeparator objects represent a separator in a chunk. <br>
...
public class LogSeparator {
    ...
    private static final byte[] HOLUX = { (byte) 'H', (byte) 'O', (byte) 'L',
            (byte) 'U', (byte) 'X' };
    private static final byte[] HEADER = { (byte) 0xAA, (byte) 0xAA,
            (byte) 0xAA, (byte) 0xAA, (byte) 0xAA, (byte) 0xAA, (byte) 0xAA };
    private static final byte[] TRAILER = { (byte) 0xBB, (byte) 0xBB,
            (byte) 0xBB, (byte) 0xBB };
