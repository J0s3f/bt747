...
public class BT747_Main extends javax.swing.JFrame implements
    ...
    private void initAppData() {
        ...
        txtPDOPMax.setText(String.format((Locale)null,"%.2f",m.getFilterMaxPDOP()));
        txtHDOPMax.setText(String.format((Locale)null,"%.2f",m.getFilterMaxHDOP()));
        txtVDOPMax.setText(String.format((Locale)null,"%.2f",m.getFilterMaxVDOP()));
        ...
        txtDistanceMin.setText(String.format((Locale)null,"%.2f",m.getFilterMinDist()));
        txtDistanceMax.setText(String.format((Locale)null,"%.2f",m.getFilterMaxDist()));
        txtSpeedMin.setText(String.format((Locale)null,"%.2f",m.getFilterMinSpeed()));
        txtSpeedMax.setText(String.format((Locale)null,"%.2f",m.getFilterMaxSpeed()));
    ...
    private void updateRMCData(final GPSRecord gps) {
        if (gps.utc > 0) {
            ...
            // TODO: Look for some ideas here: http://java.sun.com/j2se/1.5.0/docs/api/java/util/Formatter.html#syntax
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .add(jPanel3Layout.createSequentialGroup()
                ...
                .add(btConnect)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(cbPortName, 0, 434, Short.MAX_VALUE))
        );
