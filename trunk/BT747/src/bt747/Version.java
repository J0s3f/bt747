...
public final class Version {
   ...
   public static final long BUILD = 20071218184528162L; //automatically set during Ant compilation!
   public static final String BUILD_STR = "20071218184528162"; //automatically set during Ant compilation!
   /** Release date of this version (date format dd.MM.yyyy). */
   public static final String DATE = "18.12.2007"; //automatically set during Ant compilation!
   /**
    ...
    * </ul>
    */
   public static final String VERSION_NUMBER = "1.23";
