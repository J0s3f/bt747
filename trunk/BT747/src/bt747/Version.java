...
public final class Version {
   ...
   public static final long BUILD = 20080329081939489L; //automatically set during Ant compilation!
   public static final String BUILD_STR = "BT747.369M.20080329081939489"; //automatically set during Ant compilation!
   /** Release date of this version (date format dd.MM.yyyy). */
   public static final String DATE = "29.03.2008"; //automatically set during Ant compilation!
   /**
