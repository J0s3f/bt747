...
public final class Version {
   ...
   public static final long BUILD = 20070722234344326L; //automatically set during Ant compilation!
   /** Release date of this version (date format dd.MM.yyyy). */
   public static final String DATE = "22.07.2007"; //automatically set during Ant compilation!
   /**
    ...
    * </ul>
    */
   public static final String NUMBER = "0.77.11";
