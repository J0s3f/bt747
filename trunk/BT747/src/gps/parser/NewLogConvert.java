            ...
            for (LogPacket packet : lf) {
                ...
                if(passToFindFieldsActivatedInLog) {
                    ...
                    if(format!=packet.recFormat()) {
                        gpsFile.writeLogFmtHeader(getLogFormatRecord(format=packet.recFormat()));
                    }
                    r.recCount=i;
...
//       d.valid= r.valid;
       if(r.fix!=null) { d.valid=r.fix; } else { d.valid=0xFFFF; };
       if(r.latitude!=null) d.latitude= r.latitude;
       if(r.longitude!=null) d.longitude= r.longitude;
       if(r.height!=null) d.height= r.height;
       if(r.speed!=null) d.speed= r.speed;
       if(r.heading!=null)d.heading= r.heading;
       if(r.dsta!=null)d.dsta= r.dsta;
       if(r.dage!=null)d.dage= r.dage;
       if(r.pdop!=null)d.pdop= r.pdop;
       if(r.hdop!=null)d.hdop= r.hdop;
       if(r.vdop!=null)d.vdop= r.vdop;
       ...
       if(r.recordingMethod!=null) d.rcr= r.recordingMethod; else d.rcr=1;
       if(r.milliseconds!=null)    d.milisecond= r.milliseconds;
