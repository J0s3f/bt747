...
public final class IphoneFile implements BT747RAFile {
     ...
     */
    public IphoneFile(final String path) {
        filePath = path;
    }
     ...
     *                this system.
     */
    public IphoneFile(final String path, final int mode, final int card) {
        this(path, mode);
    }
     ...
     *                The way the file should be opened.
     */
    public IphoneFile(final String path, final int mode) {
        try {
            String modeStr = "";
            filePath = path;
            switch (mode) {
