...
/**
 * A horizontal rule component. It is a line across the screen used to
 * demarkate sections of a form.
 */
public class HorizontalRule extends Component {
    ...
    /**
     * The percentage of the screen's width the horizontal rule occupies.
     */
     ...
     *                is the length of the line relative to the width of the
     *                screen. It must be between 0.00 and 1.00.
     */
    public void setWidthOfScreen(final double percentageOfScreen) {
     ...
     * 
     * @return The length of the line relative to the width of the screen.
     */
     ...
     * 
     * @param pixels
     *                is how many pixels high the horizontal line will be. It
     *                must be at least 1.
     */
    ...
    protected void paintComponent(final Graphics g, final Theme theme,
        ...
        final int lineWidth = (int) (width * widthPercentage);
        int lineX;
        ...
        final int color = theme.getBorderColor();
        g.setColor(color);
