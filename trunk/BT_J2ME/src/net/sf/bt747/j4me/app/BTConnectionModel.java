...
public class BTConnectionModel
{
	/**
    ...
    /**
     * @param gpsBluetoothConnection the gpsBluetoothConnection to set
     */
    public final void setGpsBluetoothConnection(BluetoothGPS gpsBluetoothConnection) {
