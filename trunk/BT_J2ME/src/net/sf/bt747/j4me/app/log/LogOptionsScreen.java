...
public class LogOptionsScreen extends Dialog {
    ...
    /**
     * The UI component that lets the user select the level at which the
     * applications logs.
     */
     ...
     */
    public LogOptionsScreen(final DeviceScreen previous) {
        // Record the screens.
        ...
        final Level current = Log.getLogLevel();
        int selection = -1;
    ...
    protected void acceptNotify() {
        ...
        final int selection = logLevel.getSelectedIndex();
